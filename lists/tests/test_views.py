...
class ListViewTest(TestCase):
    ...
    def test_display_only_items_for_that_list(self):
        ...
        Item.objects.create(text='other list item 1', list=other_lost)
        Item.objects.create(text='other list item 2', list=other_lost)
    ...
    def test_validation_erroes_end_up_on_lists_page(self):
        list_ = List.objects.create()
